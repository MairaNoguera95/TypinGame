const text = [
    ...
    'No hay nada mas enganhoso que un hecho evidente.',
    'Deberia saber a estas alturas que cuando un hecho parece oponerse a una larga serie de deducciones, invariablemente demuestra ser capaz de soportar alguna otra interpretacion.',
    'Nunca hago excepciones. Una excepcion invalida la regla.',
    'Lo que un hombre puede inventar otro puede descubrir.',
    'Nada aclara tanto un caso como explicarselo a otra persona.',
    'La educacion nunca termina, Watson. Es una serie de lecciones, con la mayor para la ultima.',
];
...
document.getElementById('inicio').addEventListener('click', () => {
    ...
    const textoIndice = Math.floor(Math.random() * text.length);
    const texto = text[textoIndice];
